...
public static class MimirModuleLibrary
{
    ...
    [
        ...
        new(
            ...
            ["mimir.move_calibration_protocol.v1", "mimir.quest_usb_preflight.v1", "mimir.move_controller_pose.v1", "mimir.move_controller_pose_stream_frame.v1", "muninn.move_marker_candidate.v1", "muninn.move_controller_state.v1"],
            [
                ...
                "dotnet run --project .\\src\\Mimir.BufferSmoke\\Mimir.BufferSmoke.csproj -- --quest-usb-preflight-smoke",
                "dotnet run --project .\\src\\Mimir.BufferSmoke\\Mimir.BufferSmoke.csproj -- --move-fusion-smoke"
            ]),
        new(
            "path-learning",
