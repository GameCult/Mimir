...
if (-not $SkipMoves) {
    ...
    $moveArgs = @(
        ...
        "--max-brightness", "0.16",
        "--brightness-exponent", "1.2",
        "--score-subdivisions", "8",
        "--score-instrument-spacing", "3",
        "--score-release", "0.50",
        "--score-loudness-threshold", "0.97",
        "--score-min-loudness-gate", "0.18",
        "--score-loudness-exponent", "3.0",
        "--score-min-accent", "0.04",
        "--score-max-envelope", "0.40",
