...
This repo root is the Obsidian vault. It indexes the live Mimir machine, the
research spine, and the persistent state surfaces without moving the markdown
corpus.
