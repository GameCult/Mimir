# Fensalir Spatial Audio

Fensalir hosts the Mimir runtime UI and presents the synchronized program
...
- Fensalir shows controls and debug state, then routes final outputs toward OBS.
