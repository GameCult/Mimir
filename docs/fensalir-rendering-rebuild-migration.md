...
- implemented synthetic multi-camera marker proof: Mimir lowers a deterministic
  camera marker candidate with calibration/marker identity and a world-space
  confidence envelope, and Fensalir plans it as a `DebugOverlay` FieldEvidence
  packet;
