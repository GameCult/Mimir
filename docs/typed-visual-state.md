...
Typed visual state now means native/runtime descriptors and Fensalir-readable
...
- Fensalir decodes visual payloads, runs GPU fusion, and publishes the program
  surface.
